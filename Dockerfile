...
RUN cd dlza-frontend && rm package-lock.json && echo "PUBLIC_BACKEND_URL=https://dlza-manager.ub-dlza-prod.k8s-001.unibas.ch/graphql" >> .env && npm install && npm run build
