...
require (
	...
	github.com/ocfl-archive/dlza-manager-handler v1.0.3-beta4
	github.com/ocfl-archive/dlza-manager-storage-handler v1.0.3-beta3
...
require (
	...
	github.com/je4/filesystem/v3 v3.0.37 // indirect
